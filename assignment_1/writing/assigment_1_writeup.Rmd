...
**Figure 3:** A comparision of Euler and Huen's Methods for $\beta \in {0.03, 0.06, 0.1}$ for the step size $h = 0.01$, with $\gamma = 0.25$ and initial conditions of $(S, I) = (90, 10)$.
...
**Figure 4:** A comparision of Euler and Huen's Methods for $\beta \in {0.03, 0.06, 0.1}$ for the step size $h = 0.5$, with $\gamma = 0.25$ and initial conditions of $(S, I) = (90, 10)$.
...
df %>%
  ...
  facet_wrap(~ beta, nrow = 1)
```
**Figure 5:** A comparision of Euler and Huen's Methods for $\beta \in {0.03, 0.06, 0.1}$ for the step size $h = 2.0$, with $\gamma = 0.25$ and initial conditions of $(S, I) = (90, 10)$.

Is there a noticeable difference between the two methods? What might be going on?

## Answer 4
With very low step sizes (_i.e._ h = 0.01) there is hardly a noticible difference between the two methods (Fig 1 A. B. C.) However, as you begin to increase the step size significantly (_i.e._ 50 times larger at h = 0.5), then there begins to be a noticeable difference between the two methods. The error in Huen's method 
